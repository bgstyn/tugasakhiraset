...
@section('title', 'Tambah Lokasi Baru - IT Asset Management')
@section('page_title', 'Tambah Lokasi Baru')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-slate-900 border border-slate-800/80 rounded-2xl p-6 md:p-8 shadow-lg">
        <div class="mb-6 border-b border-slate-800 pb-4">
            <h3 class="text-lg font-bold text-white">Detail Lokasi Kampus Baru</h3>
            <p class="text-xs text-slate-400 mt-1">Masukkan spesifikasi gedung dan ruangan yang baru untuk penempatan aset IT.</p>
        </div>
        ...
        <form action="{{ route('locations.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="kode_ruangan" name="kode_ruangan" required value="{{ old('kode_ruangan') }}"
                ...
                <div>
                    ...
                    <input type="text" id="nama_ruangan" name="nama_ruangan" required value="{{ old('nama_ruangan') }}"
                ...
                <div>
                    ...
                    <input type="number" id="lantai" name="lantai" required value="{{ old('lantai') }}" min="1" max="10"
                        class="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-white placeholder-slate-500 outline-none transition"
